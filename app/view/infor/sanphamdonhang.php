...
<head>
    ...
    <link rel="stylesheet" href="sanphamdonhang.css">
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <div class="main-content-infor">
                <div id="titlebar">
                    <ul>
                        <li><a href="/infor/lichsu.html">ĐANG XỬ LÝ</a></li>
                ...
                <div class="order-progress">
                    ...
                    <div class="progress-container">
                        ...
                        <div class="step">
                            ...
                            <div class="in-icon"><i class="fa-solid fa-pager"></i></div>
                            <div class="progress-word">Đã Đặt Hàng</div>
                        </div>
                        <div class="step">
                            <div class="step-icon"></div>
                            <div class="in-icon"><i class="fa-solid fa-money-bills"></i></div>
                            <div class="progress-word">Xác Nhận Thông Tin Thanh Toán</div>
                        </div>
                        <div class="step">
                            <div class="step-icon"></div>
                            <div class="in-icon"><i class="fa-solid fa-truck"></i></div>
                            <div class="progress-word">Đã Giao Hàng Cho DVVC</div>
                        </div>
                        <div class="step">
                            <div class="step-icon"></div>
                            <div class="in-icon"><i class="fa-solid fa-truck-fast"></i></div>
                            <div class="progress-word">Đang Giao Hàng</div>
                        </div>
                        <div class="step">
                            <div class="step-icon"></div>
                            <div class="in-icon"><i class="fa-solid fa-box"></i></div>
                            <div class="progress-word">Đã Nhận Hàng</div>
                        </div>
                    </div>
                    ...
                    <div class="timeline">
                        <div class="step-alt">
                            ...
                            <div class="info">
                                <h3>Đã đặt hàng</h3>
                                <p><strong>Thời gian:</strong> 12:00 PM, 14/11/2024</p>
                        ...
                        <div class="step-alt">
                            ...
                            <div class="info">
                                ...
                                <p><strong>Thời gian:</strong> 1:30 PM, 14/11/2024</p>
                                <p><strong>Địa điểm:</strong> Hà Nội</p>
                            </div>
                        </div>
                        <div class="step-alt">
                            ...
                            <div class="info">
                                <h3>Đã giao hàng cho đơn vị vận chuyển</h3>
                                <p><strong>Thời gian:</strong> 2:00 PM, 14/11/2024</p>
                                <p><strong>Địa điểm:</strong> Kho vận chuyển, Hà Nội</p>
                            </div>
                        </div>
                        <div class="step-alt">
                            ...
                            <div class="info">
                                ...
                                <p><strong>Thời gian:</strong> 3:00 PM, 14/11/2024</p>
                                <p><strong>Địa điểm:</strong> Đang trên đường đến TP. Hồ Chí Minh</p>
                            </div>
                        </div>
                        <div class="step-alt">
                            ...
                            <div class="info">
                                <h3>Đã nhận hàng</h3>
                                <p><strong>Thời gian:</strong> 10:00 AM, 15/11/2024</p>
                                <p><strong>Địa điểm:</strong> TP. Hồ Chí Minh</p>
                            </div>
                        </div>
                    </div>
                    <div class="buttons">
                        <button class="button">Đánh Giá</button>
                        <button class="button button-secondary">Yêu Cầu Trả Hàng/Hoàn Tiền</button>
                        <button class="button button-secondary">Liên Hệ Người Bán</button>
                        <button class="button button-secondary">Mua Lại</button>
                    </div>
                </div>
            </div>
        </div>
